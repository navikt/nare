...
var tip = d3.tip()
    ...
    .offset([-10, 0])
    .html(function(d) {
        return "<div> ID: <span style='color:lightblue'>"+ d.identifikator+"</span></div> " +
            "<div> Beskrivelse: <div style='color:lightblue'>"+ d.beskrivelse+"</span></div> " +
            "<div> Evaluering: <div style='color:lightblue'>"+ d.begrunnelse+"</div></div>";
    })
...
function update(source) {
    ...
    nodeEnter.append("text")
        ...
        .text(function (d) {
            return d.children ? "" : d.begrunnelse;
        })
        .style("fill", "#BEBEBE");
